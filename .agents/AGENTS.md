...
- **¡IMPORTANTE!** Cada vez que se genere una nueva versión de la aplicación (para GitHub Releases o distribución), se **debe cambiar obligatoriamente la numeración** en el archivo `frontend/src-tauri/tauri.conf.json` (además de `package.json`,`Cargo.toml` y los labels del frontend ). 
